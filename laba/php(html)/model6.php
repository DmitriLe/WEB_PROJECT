...
$result1=mysqli_query($induction, "SELECT * FROM `Kaptur`");
$result2=mysqli_query($induction, "SELECT * FROM `Kaptur`");
...
<head>
    ...
    <link rel="stylesheet" href="https://laba/css/model6.css">
</head>
<body>
    <header class="header">
    ...
    <div style="height: 1000px; background-color:#000000;">
        ...
        <div>
            <br/>
            <h1 class="text2" style="margin-left:540px; font-size: 35px;">Renault Kaptur</h1>
            <div>
                <div style="margin-left:20px;">
                    ...
                    <p class="text2" style="margin-top:-20px;">Renault Kaptur имеет общую платформу с моделью Renault Duster, в отличие от похожей внешне модели Renault Captur, имеющей в основе другую платформу. Также Kaptur отличается большей колёсной базой и дорожным просветом. Kaptur производится и продаётся преимущественно в странах с развивающейся экономикой. Кроссовер Kaptur базируется на модернизированной платформе B0, которая получила название «Captur Global Access». В основе платформы лежит H4M или F4R (оба с увеличенной мощностью и пониженным расходом топлива), новая подвеска с увеличенной жёсткостью пружин и иными амортизаторами.</p>
                    <p class="text2" style="font-size: 35px;">Цена:</p>
                    <p class="text2" style="font-size: 30px; margin-top:-20px;">2 150 000 руб.</p>
                </div>
            </div>
